...
availability+=(
        ...
        ["JUWELS"]=" 1.1.0 1.1.0MCT 1.2.0 1.2.0MCT 2.1.0 2.1.0MCT 2.0.5 2.0.5MCT 3.0.0 3.0.0MCT 3.1.0 3.1.0MCT 1.1.0MCTPDAF 
                     1.4.0MCT 1.4.1MCT 3.0.0MCTPDAF 1.4.2MCT "
...
versions+=(
	...
	["1.4.1MCT"]="4.0.0 old clm3_5 but new icon-lem and Parflow3_2 with Oasis3-MCT"
        ["1.4.2MCT"]=" icon-nwp icon-2.5.0 standalone"
)
...
modelVersion+=(
	...
	["1.4.1MCT"]="oasis3-mct clm3_5-icon icon-lem parflow3_2"
        ["1.4.2MCT"]="oasis3-mct clm3_5-icon icon-nwp parflow3_2"
)
...
setups+=(
	...
	["icon-ccs"]="icon non-hydrostatic convective boundary layer (Anurag et al. 2015)"
        ["icon-nwp"]="icon non-hydrostatic convective boundary layer stand alone in nwp mode (Anurag et al. 2015)"
)

# list of setups that are available on a machine. (first is default)
# IMPORTANT: add a leading and trailing " "(space)
setupsAvail+=(
	["JUWELS"]=" nrw ideal300150 ideal600300 ideal1200600 ideal24001200 cordex idealRTD multi-scale rur icon-ccs bonnRadar bonn seabreeze smresponse scalingStudy icon-nwp "
